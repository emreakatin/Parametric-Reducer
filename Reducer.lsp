...
(defun knm1 ()
  ...
  (hels)
  (setq cark (ssget "l"))
  (command "copyclip" cark "")
  (command "erase" "all" "")
  (command "pasteclip" (list -20 0 0 ))
  (command "pasteclip" (list -20 0 70 ))
  (command "pasteclip" (list -20 35 35 ))
...
(defun knm2 ()
  ...
  (bearing)
  (setq rlmn (ssget "l"))
  (command "copyclip" rlmn "")
  (command "pasteclip" (list 0 50 0 ))
)
